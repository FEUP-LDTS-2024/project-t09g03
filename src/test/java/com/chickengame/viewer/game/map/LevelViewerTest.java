...
public class LevelViewerTest {
    ...
    public void helper()
    {
        ...
        this.finishedLineViewer = Mockito.mock(ElementViewer.class);
        ...
        this.finishedLine = Mockito.mock(Element.class);
        ...
        Mockito.when(location.getFinishLine()).thenReturn(finishedLine);
        ...
        Mockito.when(elementViewerFactory.getViewer("finishLine")).thenReturn(finishedLineViewer);
        ...
        Mockito.when(finishedLine.getPosition()).thenReturn(position);
    ...
    public void drawElements() throws IOException {
        ...
        Mockito.verify(finishedLineViewer,Mockito.times(1)).draw(gui,finishedLine);
